...
|            | Description                                                                                                                                                                                                                                                                                                                                              | Fill in |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Tech Stack | What tech stack will you use for your final project? It is recommended to use the following technologies in this project: Python/Flask, PostgreSQL, SQLAlchemy, Heroku, Jinja, RESTful APIs, JavaScript, HTML, CSS. Depending on your idea, you might end up using WTForms and other technologies discussed in the course.                               | Python/Flask, PostgreSQL, SQLAlchemy, Jinja, RESTful APIs, JavaScript, HTML, CSS, WTForms        |
| Type       | Will this be a website? A mobile app? Something else?                                                                                                                                                                                                                                                                                                    |Website         |
| Goal       | What goal will your project be designed to achieve?                                                                                                                                                                                                                                                                                                      |Make shopping and cooking easier by providing a quick way to pick recipes based on ingredients or diet.        |
| Users      | What kind of users will visit your app? In other words, what is the demographic of your users?                                                                                                                                                                                                                                                           |Any adult who cooks food. Especially relevant for those with dietary restrictions.         |
| Data       | What data do you plan on using? How are you planning on collecting your data? You may have not picked your actual API yet, which is fine, just outline what kind of data you would like it to contain. You are welcome to create your own API and populate it with data. If you are using a Python/Flask stack, you are required to create your own API. |Data on recipes including the required ingredients. I plan on using Spoonacular API and YouTube API.         |
...
| Meal Plan         | Ability to save recipes in a meal plan section and organize them by day/week. List of ingredients are compiled based on meal plan.                                     |Hard, Frontend, Stretch|
| Email List         | Use Flask Mail to email meal plan to users. Email something else if I cannot get meal plan to work.                                     |Medium, Backend |
| Recommendations Section         | Create recommendations for users based on recipes saved to user profile                                |Medium, Fullstack, Must Have |
| Recipe Search         | Users will be able to search for recipes based on cuisine, diet, and/or ingredients                                |Medium, Fullstack, Must have |
| Recipe Details         | Users will be able to view details of a recipe including ingredients, instructions, and video of recipe being made (using YouTube API)                               |Hard, Backend, Stretch (Video) |
