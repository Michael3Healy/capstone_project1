...
class UserAddForm(FlaskForm):
    ...
    diet = SelectField('Diet', choices=[('none', 'None'), ('vegetarian', 'Vegetarian'), ('lacto-vegetarian', 'Lacto-Vegetarian'),
                                                    ('ovo-vegetarian', 'Ovo-Vegetarian'), ('vegan', 'Vegan'), ('pescetarian', 'Pescetarian'),
                                                    ('paleo', 'Paleo'), ('low-fodmap', 'Low FODMAP'), ('whole30', 'Whole30')])
